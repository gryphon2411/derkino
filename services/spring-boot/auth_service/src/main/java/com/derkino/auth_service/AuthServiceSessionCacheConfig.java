...
import com.derkino.commons.security.CustomUserMixin;
import com.derkino.commons.security.LinkedHashSetMixin;
...
public class AuthServiceSessionCacheConfig implements BeanClassLoaderAware {
    ...
    @Value("${derkino.cache.session.redis.host:localhost}")
    private String sessionCacheHost;
    @Value("${derkino.cache.session.redis.port:6379}")
